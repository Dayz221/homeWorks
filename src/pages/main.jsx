      ...
      <div className="body_container">
          <div className="main_menu">
            ...
            <div className="menu_data">
              <div className="tasks_count" style={{ borderColor: `rgb(${getGradient(255,68,35, 112,255,105, numOfCompletedTasks/tasks.length)})`, backgroundColor: `rgba(${getGradient(255,68,35, 112,255,105, numOfCompletedTasks/tasks.length)}, .4)` }}>
